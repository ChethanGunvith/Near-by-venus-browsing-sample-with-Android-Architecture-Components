...
class ApiResponseTest {
    ...
    fun link() {
        val link =
            "<https://api.foursquare.com/v2/venues/search?client_id=VVLRKMJWUSDI44T0SSZVLQ0FJRRC5ZXPWQAIQSKKPEKRXNDW\n" +
    ...
    @Test
    fun badLinkHeader() {
        val link = "<https://api.foursquare.com/v2/venues/search?client_id=VVLRKMJWUSDI44T0SSZVLQ0FJRRC5ZXPWQAIQSKKPEKRXNDW\n" +
                "  &client_secret=VTCYNUTZ3LHS31XDYEA0L0KC1ENXHCLIXCLNINJCUOLOMUBP\n" +
                "  &near=Rotterdam\n" +
                "&radius=1000\n" +
                "  &v=20190503>"
